...
class VisaApplication(models.Model):
    ...
    EMPLOYER_POSTAL_CODE = models.CharField(max_length=10,blank=True, null=True)
    ...
    SOC_CODE = models.CharField(max_length=10,blank=True, null=True)
    ...
    WORKSITE_POSTAL_CODE = models.CharField(max_length=10,blank=True, null=True)
